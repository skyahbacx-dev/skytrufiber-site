...
<div id="tabs">
    ...
    <a href="survey_responses.php" class="tab-link">📝 Survey Responses</a>
    <a href="update_profile.php" class="tab-link">👤 Edit Profile</a>
    <a href="csr_logout.php" class="tab-link">🚪 Logout</a>
</div>
