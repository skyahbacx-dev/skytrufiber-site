...
<div class="export-buttons">
    <a class="export-btn" target="_blank" 
       href="print_ticket_report.php?ticket=<?= $ticketID ?>">
        📄 Export Report
    </a>

    <a class="export-btn chat" target="_blank" 
       href="print_ticket_chat.php?ticket=<?= $ticketID ?>">
        💬 Export Chat View
    </a>
</div>
