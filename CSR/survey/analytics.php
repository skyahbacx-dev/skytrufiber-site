...
<form method="GET" class="sky-card" style="display:flex; flex-wrap:wrap; gap:10px; align-items:flex-end; margin-bottom:20px;">
    ...
    <?php if ($range === 'custom'): ?>
        <div class="sky-field" style="margin:0;"><label>From</label><input type="date" name="date_from" class="sky-input" value="<?= htmlspecialchars($date_from) ?>"></div>
        <div class="sky-field" style="margin:0;"><label>To</label><input type="date" name="date_to" class="sky-input" value="<?= htmlspecialchars($date_to) ?>"></div>
