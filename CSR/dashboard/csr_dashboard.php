...
<div class="sidebar-collapsed">
    ...
    <button class="icon-btn logout" onclick="window.location='home.php'" title="Logout">🚪</button>
</div>
...
<div class="sidebar" id="sidebar">
    ...
    <button class="side-item logout" onclick="window.location='home.php'">🚪 Logout</button>
</div>
